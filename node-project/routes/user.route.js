...
import {
     getAllUsers, createUser, getUserById, updateUser, deleteUser, resetPassword, restoreUser
} from "../controllers/userManagement.controller.js";
import { auth } from "../middlewares/auth.middleware.js";
import {roleMiddleware} from "../middlewares/role.middleware.js";
export default router;

router.post("/", auth,roleMiddleware("admin"), createUser);
...
router.post("/restore/:id", auth, roleMiddleware("admin"), restoreUser);