...
export class PatientManagementService {
  ...
  getAllPatients(filters: any = {}) {
    ...
    createPatient(patientData: any) {
        return this.http.post(`${this.apiUrl.baseUrl}${this.apiUrl.patients}`, patientData);
    }
    updatePatient(patientId: string, patientData: any) {
        return this.http.put(`${this.apiUrl.baseUrl}${this.apiUrl.patients}/${patientId}`, patientData);
    }
    deletePatient(patientId: string) {
        return this.http.delete(`${this.apiUrl.baseUrl}${this.apiUrl.patients}/${patientId}`);
    }
    exportPatientsCSV() {
        return this.http.get(`${this.apiUrl.baseUrl}${this.apiUrl.patients}/export`, { responseType: 'blob' });
